...
SEATNO:<input type="text" name="SEATNO" value=w1 placeholder="Seat NO" required="required"><br>
...
Mobile No: <input type="longnumber" name="PHONE"  placeholder="Your mobileno" required="required"><br>
AdharNo:<input type="longnumber" name="ADHARNO"  placeholder="Your adharno" required="required"><br>
